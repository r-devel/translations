...
[![](https://translate.rx.studio/widgets/r-project/ne/svg-badge.svg?native=1){fig-align="left" fig-alt="translation status"}](https://translate.rx.studio/languages/ne/r-project/)

_This repository is a hub for all people who want to help translate R into Nepali. This README is in English, but you 
can reach out to other translators on the R Contributors Slack if you need any additional information about the 
project._

## About

The goal of the _np_ project is to bring together all people interested in helping translate the [R 
language](https://en.wikipedia.org/wiki/R_(programming_language)) into Nepali. If you use R a lot, we need your help!
...
1. List every Nepali [component](https://translate.rx.studio/languages/ne/r-project/);
...
Translating R programming messages and warnings from English to Nepali requires careful attention to both the technical 
...
Few glossaries are imported from: [Link 
1](https://www.rcsdk12.org/cms/lib/NY01001156/Centricity/Domain/9641/ms_6_8_intermediate%20math_Nepali%20ver5-2-1.pdf) | 
[Link 2](https://docs.steinhardt.nyu.edu/pdfs/metrocenter/atn293/msmath/MS6to8IntermediateMathNepali2014.pdf) | 
[Microsoft Style 
Guide](https://download.microsoft.com/download/a/f/2/af2a5739-c56b-44ae-8d21-1ee5f26e8a6c/nep-npl-styleguide.pdf)
